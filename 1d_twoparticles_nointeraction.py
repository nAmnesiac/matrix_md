...
# update matrices unchanged from 1d single particle
...
# history is now 3 x (num_steps * numberofatoms)
# stored as a 3d array: (3, numberofatoms, num_steps)
history = np.zeros((3, numberofatoms, num_steps))

#==========integration loop=======
for step in range(num_steps):
    params = master_update @ params  # applies to both columns simultaneously

    # boundary conditions for each particle
...
ax.set_title("1D Two-Particle Simulation")
